        ...
        if(!IPServer.equals("")){
            if(getStatusCol(sltRow).isEmpty()){
                ...
                try{
                    ...
                    showMess(this,"SeedFileError : " + e.toString());
                }
                ...
                try{
                    ...
                    else showMess(this,"Cannot reseed this file!");
                    
                }catch(Exception e){
                    showMess(this,"Reseed Error : " + e.getMessage());
                }
            }
        }else{
...
private void addHashButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addHashButtonActionPerformed
    ...
    if(str != null){
        try{
            ...
            showMess(this,"Invalid ID (number only) : "+str);
        }
    }
        ...
        if(getStatusCol(selectRow).equals("Seeding")){
            ...
            try{
                ...
                if(success){
                    ...
                    client.finish();
                }else showMess(this,"Cannot stop this file!");
                
            }catch(Exception e){
                showMess(this,e.toString());
            }
        }
    }
    ...
    if(!IPServer.equals("")){
        try{
            ...
            if(success){
                ...
                showMess(this,"Connect successfully to server");
            } else{
                showMess(this,"Server doesn't exist");
            }
        }catch(Exception e){
            showMess(this,"Cannot connect to server!");
        }
    }
