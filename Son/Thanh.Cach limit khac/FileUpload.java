        ...
        try{           
            ...
            if(fileName.equals("")){//cannot file the specified file
                ...
                if (!leecherStatus.equals("NOT_YET")){
                    ...
                    byte[] buffer = new byte[maxByteSendPerTime];
                    ...
                    int byteThisTime = 2048;
                    stopClock.press();
                    while(running && (bytesRead = raf.read(buffer, 0, byteThisTime)) >0)
                    {   
                        
                        /*Write file from offSet to leecher*/
                        output.write(buffer,0,bytesRead);
                        byteThisTime = (int) (stopClock.press() * sndspeed);
