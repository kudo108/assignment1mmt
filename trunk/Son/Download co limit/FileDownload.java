...
//                sk = new Socket(theTuple.getIP(),22221);
                ...
                InetSocketAddress sa = new InetSocketAddress(theTuple.getIP(),22222);
                sk.setReceiveBufferSize(512);
                sk.connect(sa);
                
                this.spdctr = new SpeedControler(sk);
...
//                        FileWriter writer = new FileWriter(UI,fileSize,buffer,currentRow,raf,offSet);
                        ...
                        while(running &&(bytesReceived = input.read(buffer, 0, spdctr.getReceiveBufferSize()))>0){
