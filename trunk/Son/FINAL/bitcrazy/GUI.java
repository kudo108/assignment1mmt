...
//        setDefaultIP();
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("src/Icon/Download-icon (Copy).png"));
        ...
        try{
            FileTable.setDefaultRenderer(Class.forName("java.lang.Integer"), renderer);
        }catch (Exception e){
            System.out.println(e);
        }
        FileTable.getColumn("Progress").setCellRenderer(renderer);
...
public void addRow(int init){
    model.addRow(new Object[]{null,null,null,null,null,new Integer(init),null});
}
...
public void setSpeed(int speed, int sltRow){
    ...
    float speedGB =  (float)speed/(1024*1024*1024);
    float speedMB =  (float)speed/(1024*1024);
    float speedKB =  (float)speed/(1024);
    if(speed >= 1024*1024*1024) calcSpeed = dec.format(speedGB).toString() + "GB/s";
    else if(speed >= 1024*1024) calcSpeed = dec.format(speedMB).toString() + "MB/s";
    else if(speed >= 1024) calcSpeed = dec.format(speedKB).toString() + "KB/s";
